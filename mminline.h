 ...
 * (in other words, returns 1 if the right-most bit in b->size is set, 0 otherwise)
 */
 ...
 * Think about how to remove this bit from b->size while preserving the rest of its bits
 * (hint: -2 is 111...1110 in binary)
 */
 ...
 * Think about what functions you've implemented above that could be useful to call here
 */
 ...
 * Make sure to set the right-most bit of the size to be 1 if the block is marked as allocated
 */
 ...
 * 
 * Sets the allocated flags of the block, at both the beginning and the end tags.
 * Depending on whether the block is being marked as allocated or free, you
 * should set the rightmost bit of the size (at beginning and end tags) accordingly
 * (hint: -2 is 111...1110 in binary)
 */
 ...
 * This is a convenience function to set the size and allocation of a block in one call --
 * you can call functions you've already implemented here!
 */
 ...
 * NOTE: similar to block_size, you need to remove the right-most bit (the 'is-allocated' bit)
 * (remember -2 is 111...1110 in binary)
 */
